...
logoImg = ImageTk.PhotoImage(Image.open(resource_path("assets/logo_6-28-23.png")))
...
def askfor_oto(func):
    global filename
    filename = filedialog.askopenfilename(initialdir="/", title="Select oto.ini file", filetypes=(("Config files", "*.ini"), ("Text files", "*.txt")))
...
def askfor_split(func):
    global dirname
    dirname = filedialog.askdirectory(initialdir="/", title="Select output folder")
